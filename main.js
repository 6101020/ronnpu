 ...
 function drawCirc_left(canvas) {
     ...
     for (let i = 0; i < random; i++) {
         ctx.beginPath();
         var randomx = Math.floor(Math.random() * (window.innerWidth - 39)) + 20;
         var randomy = Math.floor(Math.random() * (window.innerHeight - 5 - (randomx / window.innerWidth * window.innerHeight + 5) + 1)) + randomx / window.innerWidth * window.innerHeight + 5;
     ...
     for (let i = 0; i < 20 - random; i++) {
         ctx.beginPath();
         var randomx = Math.floor(Math.random() * (window.innerWidth - 39)) + 20;
         var randomy = Math.floor(Math.random() * ((randomx / window.innerWidth * window.innerHeight) - 9)) + 5;
         ctx.arc(randomx, randomy, 10, 0, 2 * Math.PI);
         ctx.fillStyle = "rgb(255,0,0)";
         ctx.fill();
     }
 ...
 function drawCirc_ambiguous(canvas) {
     ...
     for (let i = 0; i < 20 - random; i++) {
         ctx.beginPath();
         var randomx = Math.floor(Math.random() * (window.innerWidth - 39)) + 20; //width - 20 -20 + 1
         var randomy = Math.floor(Math.random() * (window.innerHeight - 5 - (randomx / window.innerWidth * window.innerHeight + 5) + 1)) + randomx / window.innerWidth * window.innerHeight + 5;
         ctx.arc(randomx, randomy, 10, 0, 2 * Math.PI);
         ctx.fillStyle = "rgb(255,0,0)";
         ctx.fill();
